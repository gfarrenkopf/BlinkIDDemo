...
public class RegistrationForm {
    ...
    private String date_of_birth = "03-09-1993";
    private String id_number = "T63296756";
    private boolean first_registration = true;
    private String home_zip_code="22801";
    private boolean us_citizen = true;
    private boolean has_state_license = true;
    private boolean is_eighteen_or_older = true;
    private String name_title;
    private String first_name = "Bao";
    private String middle_name = "Dinh";
    private String last_name = "Pham";
    private String name_suffix;
    private String home_address= "1141 Rebecca Ridge CT";
    private String home_unit;
    private String home_city = "Harrisonburg";
    private String home_state_id = "VA";
